...
import { BarChart3, Boxes, LayoutDashboard, ReceiptText, Settings, ShoppingCart, Store, Truck, Users } from 'lucide-react';

/** Primary sidebar navigation for the POS. `can` gates owner-only items. */
export const mainNav: NavItem[] = [
    { title: 'Dashboard', url: '/dashboard', icon: LayoutDashboard },
    { title: 'Kasir', url: '/kasir', icon: ShoppingCart },
    { title: 'Riwayat', url: '/penjualan', icon: ReceiptText },
